<template>
  <div class="bg-brand-900 pt-medium">
    <div class="bg-[#09231A] p-medium">
      ...
      <div
        class="mx-auto my-small flex w-fit items-center justify-center gap-x-[8rem]"
      >
        <div
        ...
        >
          <img
            ...
            class="block h-medium w-medium rounded-full"
          />
          <h1 class="">{{ country.currency }}</h1>
        </div>
      </div>
    </div>
  </div>
